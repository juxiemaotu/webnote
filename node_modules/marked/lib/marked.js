...
//修改InlineLexer,在匹配到[TOC]时将其替换为完整的目录标签
...
//增加 toc 和 tocItem 两个方法,用于生成目录标签
...
//修改 Renderer 的 heading 方法,为TOC赋予id作为点击目录项的锚点
